    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Dashboard Data Rawat Inap <?= $bulan_ini . ' ' . $tahun_ini; ?></h1>
                <a href="<?= base_url('report/ranap'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm btn-generate-report">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-dark">Data Rawat Inap</h6>
...
<style>
    ...
    word-break: break-word;  /* Mengaktifkan pemotongan kata agar tidak keluar */
    white-space: normal;     /* Memungkinkan pembungkusan teks */
    overflow-wrap: break-word;  /* Alternatif pengaturan pembungkusan teks */
    }
    
    .table tbody td.diagnosa {
        word-break: break-word;
        white-space: normal;
        overflow-wrap: break-word;  /* Pembungkusan kata yang lebih baik */
    }
