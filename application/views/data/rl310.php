                ...
                <div class="col-lg-12">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <thead>
                                    ...
                                    <?php 
                                    $no = 1; 
                                    $poli_sebelumnya = null; 
                                    $rowspan = []; 

                                    // Hitung rowspan untuk setiap Poli Tujuan
                                    foreach ($RL310 as $row) {
                                        $poli = $row->Nama_Poli ?: 'Tidak Diketahui'; 
                                        if (!isset($rowspan[$poli])) {
                                            $rowspan[$poli] = 0;
                                        }
                                        $rowspan[$poli]++;
                                    }
                                    ...
                                    ?>
                                        <tr>
                                            <?php if ($poli !== $poli_sebelumnya): ?>
                                                <td style="width: 5%;" rowspan="<?= $rowspan[$poli] ?>"><?= $no++; ?></td>
                                                <td style="text-align:left" rowspan="<?= $rowspan[$poli] ?>"><?= $poli; ?></td>
                                            <?php endif; ?>
                                            <td style="text-align:left"><?= $row->Asal_Rujukan; ?></td>
                                            <td><?= $row->Total_Rujukan; ?></td> 
                                        </tr>
                                    <?php 
                                        $poli_sebelumnya = $poli;
                                    endforeach; 
                                    ?>
                                </tbody>
