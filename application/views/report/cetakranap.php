                    ...
                    <table class="table table-striped table-bordered table-responsive" id="tabeldata">
                        ...
                        <?php foreach ($Ranap as $jb): ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $data_array['Tanggal_masuk']; ?></td>
                                <td><?php echo $data_array['Tanggal_keluar']; ?></td> 
                                ...
                                <td><?php echo $data_array['ruang']; ?></td> 
                                <td><?php echo $data_array['kelas']; ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                    </table>
